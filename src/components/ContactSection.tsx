...
const ContactSection = ({
  ...
  return (
    <section
      id={id}
      className="py-20 px-4 bg-gray-50 dark:bg-gray-900 min-h-[600px] flex items-center justify-center"
    >
      <motion.div
            ...
            <Card className="bg-white dark:bg-gray-800 border-none shadow-lg">
              ...
              <CardFooter className="pt-6">
                <div className="flex space-x-4">
                  <a
                    href="http://github.com/bienjrmendoza"
                    target="_blank"
            ...
            <Card className="bg-white dark:bg-gray-800 border-none shadow-lg">
              ...
              <CardContent>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  {formStatus === "success" && (
                    <Alert className="bg-green-50 border-green-200 text-green-800 dark:bg-green-900/50 dark:border-green-900 dark:text-green-300">
                  ...
                  {formStatus === "error" && (
                    <Alert className="bg-red-50 border-red-200 text-red-800 dark:bg-red-900/50 dark:border-red-900 dark:text-red-300">
